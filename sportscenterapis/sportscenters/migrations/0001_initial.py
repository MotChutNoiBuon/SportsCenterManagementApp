# Generated by Django 5.1.6 on 2025-05-31 03:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('specialization', models.CharField(choices=[('gym', 'Gym'), ('yoga', 'Yoga'), ('swimming', 'Swimming'), ('dance', 'Dance')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_date', models.DateTimeField(auto_now=True, null=True)),
                ('status', models.CharField(default='pending', help_text='Trạng thái đăng ký (ví dụ: pending, confirmed).', max_length=10, verbose_name='Trạng thái')),
                ('gym_class', models.ForeignKey(help_text='Lớp học được đăng ký.', on_delete=django.db.models.deletion.CASCADE, to='sportscenters.class', verbose_name='Lớp học')),
                ('member', models.ForeignKey(help_text='Thành viên đăng ký lớp học.', on_delete=django.db.models.deletion.CASCADE, to='sportscenters.member', verbose_name='Thành viên')),
            ],
            options={
